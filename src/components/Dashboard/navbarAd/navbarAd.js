    ...
    return (
      ...
      <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <Link to="/" className="navbar-brand brand-logo mr-5" >
            <img src="/image/myLog.png" className="mr-2" alt="logo"/></Link>
      ...
      <div className="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <li className="mt-3 text-bold home"> <Link to="/"><i class="fas fa-home"></i>  Acceuil</Link> </li>
        <li className="mt-3 text-bold home mx-4">   <Link to="/register"  onClick={logout} >
          ...
          <li className="nav-item nav-profile dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <Link to="/register" className="dropdown-item" onClick={logout} >
                <i className="ti-power-off text-primary"></i>
