               ...
               <div className="container ">
                  <div className="col-md-12 mt-4 sol">
                      <div className='text-center mt-5 ' >
                       ...
                       <Link to="/collection"> <button className=" connexion acheter mt-4">Acheter maintenant</button></Link> 
                      </div>
                  </div>
                ...
                {/*********** Start  Section 5  **************************/}
                  ...
                  {/*********** End  Section 6  **************************/}
                   ...
                   <div className="box-item text-left mt-5 p-4">
                     ...
                     <Link to="/collection"><button className=" connexion mt-3 ">Exploiter nos produits</button></Link> 
                  </div>
                  {/*********** End  Section 7  **************************/}
                  {/*********** Start  Section 8  **************************/}
                   <div className="row mt-5 section-eight">
                       ...
                       <div className="col-md-5 col-sm-6 col-6 mt-5 text-center">
                          ...
                          <Link to="/collection"> <button className=" connexion px-5 ">Découvrir</button></Link> 
                       </div>
                    </div>
                  {/*********** End  Section 8 **************************/}
                     {/*********** Start  Section 9  **************************/}
